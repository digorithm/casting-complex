...
router.get('/', async function(req, res) {
  ...
  var model = ["Ethnicity", "Credit", "Hair", "Role", "RosterType", "Union", "Gender", "Eye", "Country", "CastingSpecialization", "BreakdownStatus", "AuditionStatus", "AuditionRequestStatus", "AgencyDivision"];
